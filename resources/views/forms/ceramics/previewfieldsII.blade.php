...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div >
            ...
            <select class="form-control border" id="pattern_name"  name="pattern_name" required>
        ...
        <div >
            ...
            <input type="text" value="{{$artifact[0]["pattern_reference"]}}"class="form-control border" id="pattern_reference"  name="pattern_reference">
    ...
    <div class="col">
        ...
        <textarea class="form-control border" id="pattern_notes"  name="pattern_notes" rows="4" value="{{$artifact[0]["pattern_notes"]}}"></textarea>
    </div><!--END COL-->
...
<div class="row">
    ...
    <div class="col">
        ...
        <select class="form-control border" id="base_mark"  name="base_mark" required>
    ...
    <div class="col">
        ...
        <input type="text" class="form-control border" id="base_mark_ref"  name="base_mark_ref" value="{{$artifact[0]["base_mark_ref"]}}">
        <div class="valid-feedback">
            optional field
        </div>
    </div><!--END COL-->
    ...
    <div class="col">
        ...
        <input type="text" value="{{$artifact[0]["base_mark_color"]}}" class="form-control border" id="base_mark_color"  name="base_mark_color" required>
        <div class="invalid-feedback">
...
<div class="row">
    ...
    <div class="col">
        ...
        <select class="form-control border" id="colonoware"  name="colonoware" required>
    ...
    <div class="col">
        ...
        <select class="form-control border" id="colono_rim_form"  name="colono_rim_form" required>
    ...
    <div class="col-2">
        ...
        <select class="form-control border" id="colono_rim_angle"  name="colono_rim_angle" required>
    ...
    <div class="col-2">
        ...
        <input type="number" step=".01" value="{{$artifact[0]["max_rim_width"]}}"class="form-control border" id="max_rim_width"  name="max_rim_width" min="0" required>
        <div class="invalid-feedback">
...
<div class="row">
    ...
    <div class="col">
        ...
        <select class="form-control border" id="colono_decoration_mode"  name="colono_decoration_mode" required>
    ...
    <div class="col">
        ...
        <select class="form-control border" id="colono_base_form"  name="colono_base_form" required>
    ...
    <div class="col">
        ...
        <select class="form-control border" id="colono_footring_form"  name="colono_footring_form" required>
...
<div class="row">
    ...
    <div class="col">
        ...
        <div>
            ...
            <select class="form-control border" id="non_plastic_paste_inclusions"  name="non_plastic_paste_inclusions" required>
        ...
        <div>
            ...
            <select class="form-control border" id="total_paste_inclusion_density"  name="total_paste_inclusion_density" required>
    ...
    <div class="col">
        ...
        <div>
                ...
                <select class="form-control border" id="wear_location"  name="wear_location" required>
        ...
        <div >
            ...
            <select class="form-control border" id="wear_pattern"  name="wear_pattern" required>
